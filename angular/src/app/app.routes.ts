...
export const APP_ROUTES: Routes = [
  ...
  },
  {
    ...
    loadComponent: () => import('./accounting/banks/bank-list.component').then(c => c.BankListComponent),
    canActivate: [authGuard, permissionGuard],
    data: { requiredPolicy: 'MyERP.Banks' },
  },
  {
    path: 'accounting/banks/new',
    loadComponent: () => import('./accounting/banks/bank-form.component').then(c => c.BankFormComponent),
    canActivate: [authGuard, permissionGuard],
    canDeactivate: [unsavedChangesGuard],
    data: { requiredPolicy: 'MyERP.Banks.Create' },
  },
  {
    ...
    canActivate: [authGuard, permissionGuard],
    canDeactivate: [unsavedChangesGuard],
    data: { requiredPolicy: 'MyERP.Banks.Edit' },
  },
  {
  ...
  {
    path: 'accounting/cheque-print-templates',
    loadComponent: () => import('./accounting/cheque-print-templates/cheque-print-template-list.component').then(c => c.ChequePrintTemplateListComponent),
    canActivate: [authGuard, permissionGuard],
    data: { requiredPolicy: 'MyERP.ChequePrintTemplates' },
  },
  {
    path: 'accounting/cheque-print-templates/new',
    loadComponent: () => import('./accounting/cheque-print-templates/cheque-print-template-form.component').then(c => c.ChequePrintTemplateFormComponent),
    canActivate: [authGuard, permissionGuard],
    canDeactivate: [unsavedChangesGuard],
    data: { requiredPolicy: 'MyERP.ChequePrintTemplates.Create' },
  },
  {
    path: 'accounting/cheque-print-templates/:id/edit',
    loadComponent: () => import('./accounting/cheque-print-templates/cheque-print-template-form.component').then(c => c.ChequePrintTemplateFormComponent),
    canActivate: [authGuard, permissionGuard],
    canDeactivate: [unsavedChangesGuard],
    data: { requiredPolicy: 'MyERP.ChequePrintTemplates.Edit' },
  },
  {
    path: 'accounting/cheque-print-templates/:id',
    loadComponent: () => import('./accounting/cheque-print-templates/cheque-print-template-form.component').then(c => c.ChequePrintTemplateFormComponent),
    canActivate: [authGuard, permissionGuard],
    data: { requiredPolicy: 'MyERP.ChequePrintTemplates' },
  },
  {
    path: 'accounting/bank-account-types',
    loadComponent: () => import('./accounting/bank-account-types/bank-account-type-list.component').then(c => c.BankAccountTypeListComponent),
    canActivate: [authGuard, permissionGuard],
    data: { requiredPolicy: 'MyERP.BankAccountTypes' },
  },
  {
    path: 'accounting/bank-account-types/new',
    loadComponent: () => import('./accounting/bank-account-types/bank-account-type-form.component').then(c => c.BankAccountTypeFormComponent),
    canActivate: [authGuard, permissionGuard],
    canDeactivate: [unsavedChangesGuard],
    data: { requiredPolicy: 'MyERP.BankAccountTypes.Create' },
  },
  {
    path: 'accounting/bank-account-types/:id/edit',
    loadComponent: () => import('./accounting/bank-account-types/bank-account-type-form.component').then(c => c.BankAccountTypeFormComponent),
    canActivate: [authGuard, permissionGuard],
    canDeactivate: [unsavedChangesGuard],
    data: { requiredPolicy: 'MyERP.BankAccountTypes.Edit' },
  },
  {
    path: 'accounting/bank-account-types/:id',
    loadComponent: () => import('./accounting/bank-account-types/bank-account-type-form.component').then(c => c.BankAccountTypeFormComponent),
    canActivate: [authGuard, permissionGuard],
    data: { requiredPolicy: 'MyERP.BankAccountTypes' },
  },
  {
    path: 'accounting/bank-account-subtypes',
    loadComponent: () => import('./accounting/bank-account-subtypes/bank-account-subtype-list.component').then(c => c.BankAccountSubtypeListComponent),
    canActivate: [authGuard, permissionGuard],
    data: { requiredPolicy: 'MyERP.BankAccountSubtypes' },
  },
  {
    path: 'accounting/bank-account-subtypes/new',
    loadComponent: () => import('./accounting/bank-account-subtypes/bank-account-subtype-form.component').then(c => c.BankAccountSubtypeFormComponent),
    canActivate: [authGuard, permissionGuard],
    canDeactivate: [unsavedChangesGuard],
    data: { requiredPolicy: 'MyERP.BankAccountSubtypes.Create' },
  },
  {
    path: 'accounting/bank-account-subtypes/:id/edit',
    loadComponent: () => import('./accounting/bank-account-subtypes/bank-account-subtype-form.component').then(c => c.BankAccountSubtypeFormComponent),
    canActivate: [authGuard, permissionGuard],
    canDeactivate: [unsavedChangesGuard],
    data: { requiredPolicy: 'MyERP.BankAccountSubtypes.Edit' },
  },
  {
    path: 'accounting/bank-account-subtypes/:id',
    loadComponent: () => import('./accounting/bank-account-subtypes/bank-account-subtype-form.component').then(c => c.BankAccountSubtypeFormComponent),
    canActivate: [authGuard, permissionGuard],
    data: { requiredPolicy: 'MyERP.BankAccountSubtypes' },
  },
  ...
  {
    path: 'tax/withholding-groups',
    loadComponent: () => import('./tax/tax-withholding-groups/tax-withholding-group-list.component').then(c => c.TaxWithholdingGroupListComponent),
    canActivate: [authGuard, permissionGuard],
    data: { requiredPolicy: 'MyERP.TaxWithholdingGroups' },
  },
  {
  ...
  {
    path: 'tax/tax-withholding-groups/new',
    loadComponent: () => import('./tax/tax-withholding-groups/tax-withholding-group-form.component').then(c => c.TaxWithholdingGroupFormComponent),
    canActivate: [authGuard, permissionGuard],
    canDeactivate: [unsavedChangesGuard],
    data: { requiredPolicy: 'MyERP.TaxWithholdingGroups.Create' },
  },
  {
    path: 'tax/tax-withholding-groups/:id/edit',
    loadComponent: () => import('./tax/tax-withholding-groups/tax-withholding-group-form.component').then(c => c.TaxWithholdingGroupFormComponent),
    canActivate: [authGuard, permissionGuard],
    canDeactivate: [unsavedChangesGuard],
    data: { requiredPolicy: 'MyERP.TaxWithholdingGroups.Edit' },
  },
  {
    path: 'tax/tax-withholding-groups/:id',
    loadComponent: () => import('./tax/tax-withholding-groups/tax-withholding-group-form.component').then(c => c.TaxWithholdingGroupFormComponent),
    canActivate: [authGuard, permissionGuard],
    data: { requiredPolicy: 'MyERP.TaxWithholdingGroups' },
  },
  ...
  },
  {
    ...
    loadComponent: () => import('./crm/opportunity-types/opportunity-type-list.component').then(c => c.OpportunityTypeListComponent),
    canActivate: [authGuard, permissionGuard],
    data: { requiredPolicy: 'MyERP.OpportunityTypes' },
  },
  {
    path: 'crm/opportunity-types/new',
    loadComponent: () => import('./crm/opportunity-types/opportunity-type-form.component').then(c => c.OpportunityTypeFormComponent),
    canActivate: [authGuard, permissionGuard],
    canDeactivate: [unsavedChangesGuard],
    data: { requiredPolicy: 'MyERP.OpportunityTypes.Create' },
  },
  {
    path: 'crm/opportunity-types/:id/edit',
    loadComponent: () => import('./crm/opportunity-types/opportunity-type-form.component').then(c => c.OpportunityTypeFormComponent),
    canActivate: [authGuard, permissionGuard],
    canDeactivate: [unsavedChangesGuard],
    data: { requiredPolicy: 'MyERP.OpportunityTypes.Edit' },
  },
  {
    path: 'crm/opportunity-types/:id',
    loadComponent: () => import('./crm/opportunity-types/opportunity-type-form.component').then(c => c.OpportunityTypeFormComponent),
    canActivate: [authGuard, permissionGuard],
    data: { requiredPolicy: 'MyERP.OpportunityTypes' },
  },
  ...
  // POS Profiles
  {
    ...
    canActivate: [authGuard, permissionGuard],
    data: { requiredPolicy: 'MyERP.PosProfiles' },
  },
  {
    ...
    canActivate: [authGuard, permissionGuard],
    canDeactivate: [unsavedChangesGuard],
    data: { requiredPolicy: 'MyERP.PosProfiles.Create' },
  },
  {
    ...
    canActivate: [authGuard, permissionGuard],
    canDeactivate: [unsavedChangesGuard],
    data: { requiredPolicy: 'MyERP.PosProfiles.Edit' },
  },
  {
