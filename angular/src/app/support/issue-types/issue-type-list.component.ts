...
import { IssueTypeService } from '../../proxy/support/issue-type.service';
import type { IssueTypeDto } from '../../proxy/support/models';
...
@Component({
  ...
  template: `
    <abp-page [title]="'::IssueTypes' | abpLocalization">
      <div class="d-flex justify-content-between gap-2 mb-3">
        <input type="text" class="form-control form-control-sm" style="width:200px"
          [(ngModel)]="searchTerm" (keyup.enter)="load()" [placeholder]="'::Placeholder:Search' | abpLocalization">
        <button class="btn btn-primary btn-sm" routerLink="/support/issue-types/new">
              ...
              <tr>
                ...
                <td>
                  <div class="btn-group btn-group-sm">
                    <a class="btn btn-outline-primary" [routerLink]="'/support/issue-types/' + item.id"><i class="fa fa-edit"></i></a>
...
export class IssueTypeListComponent implements OnInit {
  private service = inject(IssueTypeService);
  private confirmation = inject(ConfirmationService);
  private toaster = inject(ToasterService);

  items = signal<IssueTypeDto[]>([]);
  searchTerm = '';
