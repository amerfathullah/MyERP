import type { CallLogDto, CreateCallLogDto, UpdateCallLogDto, GetCallLogListDto } from './models';
...
export class CallLogService {
  ...
  failCall = (id: string, failureStatus: number, config?: Partial<Rest.Config>) =>
    this.restService.request<any, CallLogDto>({
      method: 'POST',
