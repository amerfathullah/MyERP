            ...
            <table class="table table-sm mb-0">
              <tbody>
                <tr>
                  ...
                  <td class="text-end border-0 font-monospace" style="width: 140px">{{ order.currency || 'IQD' }} {{ order.netTotal | number:'1.2-2' }}</td>
                </tr>
                @if (order.taxAmount) {
                  <tr>
                    <td class="text-end border-0"><strong>Tax:</strong></td>
                    <td class="text-end border-0 font-monospace">{{ order.currency || 'IQD' }} {{ order.taxAmount | number:'1.2-2' }}</td>
                  </tr>
                }
                <tr class="border-top">
                  <td class="text-end"><strong class="fs-5">Grand Total:</strong></td>
                  <td class="text-end font-monospace fs-5 fw-bold">{{ order.currency || 'IQD' }} {{ order.grandTotal | number:'1.2-2' }}</td>
                </tr>
              </tbody>
            </table>
          </div>
