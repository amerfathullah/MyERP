      ...
      <div class="pr-print-layout">
        ...
        <div class="print-header d-flex justify-content-between align-items-start mb-4">
          ...
          <div class="text-end">
            ...
            @if (receipt.isReturn) {
              <p class="mb-0"><span class="badge bg-warning">RETURN</span></p>
            }
          </div>
        </div>
        <hr class="my-3" />
        ...
        <div class="row mb-4">
          <div class="col-6">
            ...
            @if (supplierAddress) {
              <p class="mb-0">{{ supplierAddress }}</p>
            }
          </div>
          <div class="col-6">
            ...
            <table class="table table-sm table-borderless mb-0">
              <tbody>
                ...
                @if (receipt.supplierDeliveryNote) {
                  <tr>
        ...
        <table class="table table-bordered table-sm mb-4">
          ...
          <tbody>
            @for (item of receipt.items; track item; let i = $index) {
              <tr>
                <td>{{ i + 1 }}</td>
