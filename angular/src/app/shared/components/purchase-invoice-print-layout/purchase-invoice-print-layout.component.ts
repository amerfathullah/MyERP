      ...
      <div class="print-pi">
        ...
        <div class="print-header">
          ...
          <div class="invoice-title">
            <h2>
              @if (!invoice.isReturn) {
                <span>{{ 'PurchaseInvoice' | abpLocalization }}</span>
              }
              @if (invoice.isReturn) {
                <span>{{ 'DebitNote' | abpLocalization }}</span>
              }
            </h2>
        ...
        <!-- Reference Numbers -->
        @if (invoice.supplierInvoiceNumber || invoice.purchaseOrderNumber || invoice.purchaseReceiptNumber) {
        ...
        <table class="items-table">
          <thead>
            <tr>
              ...
              <th class="text-end" style="width:100px">{{ 'Rate' | abpLocalization }} ({{ invoice.currencyCode || 'IQD' }})</th>
              <th class="text-end" style="width:120px">{{ 'Amount' | abpLocalization }} ({{ invoice.currencyCode || 'IQD' }})</th>
            </tr>
          </thead>
          <tbody>
        ...
        <div class="totals-section">
          <table class="totals-table">
            ...
            <tr class="grand-total">
              ...
              <td>{{ invoice.currencyCode || 'IQD' }} {{ formatCurrency(invoice.grandTotal) }}</td>
            </tr>
          </table>
        </div>
        <!-- Payment Information -->
