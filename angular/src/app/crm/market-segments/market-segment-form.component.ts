...
@Component({
  selector: 'app-market-segment-form',
  standalone: true,
    ...
    <abp-page [title]="(id ? '::Edit' : '::New') | abpLocalization">
      <form [formGroup]="form" (ngSubmit)="save()">
        ...
        <div class="d-flex justify-content-end gap-2">
          <a class="btn btn-secondary" routerLink="/crm/market-segments">{{ 'Cancel' | abpLocalization }}</a>
...
export class MarketSegmentFormComponent implements OnInit {
  ...
  save(): void {
    ...
    req$.subscribe({
      next: () => {
        ...
        this.router.navigate(['/crm/market-segments']);
      },
