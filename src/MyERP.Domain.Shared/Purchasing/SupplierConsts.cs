...
public static class SupplierConsts
{
    ...
    public const int MaxRegistrationNumberLength = 50;
    public const int MaxSstRegistrationLength = 50;
    ...
    public const int MaxIdTypeLength = 20;
    public const int MaxIdValueLength = 50;
}
