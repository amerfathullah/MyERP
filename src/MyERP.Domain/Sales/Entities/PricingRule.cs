...
public class PricingRule : FullAuditedAggregateRoot<Guid>, IMultiTenant
{
    ...
    /// <summary>Set when this rule was generated by a Promotional Scheme; used for regeneration/cascade delete.</summary>
    public Guid? PromotionalSchemeId { get; set; }
    /// <summary>The specific price/product discount slab this rule was generated from.</summary>
    public Guid? PromotionalSchemeSlabId { get; set; }
