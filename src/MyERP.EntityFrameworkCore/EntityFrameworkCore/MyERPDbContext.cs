    ...
    IIdentityDbContext
{
    ...
    public DbSet<CostCenterAllocation> CostCenterAllocations { get; set; }
    public DbSet<CostCenterAllocationEntry> CostCenterAllocationEntries { get; set; }
    public DbSet<FinancialReportTemplate> FinancialReportTemplates { get; set; }
    public DbSet<FinancialReportRow> FinancialReportRows { get; set; }
    ...
    public DbSet<PosOpeningEntry> PosOpeningEntries { get; set; }
    ...
    public DbSet<SerialAndBatchEntry> SerialAndBatchEntries { get; set; }
    public DbSet<ItemStandardCost> ItemStandardCosts { get; set; }
    public DbSet<RepostItemValuation> RepostItemValuations { get; set; }
    public DbSet<WarehouseAccount> WarehouseAccounts { get; set; }
    public DbSet<CustomsTariffNumber> CustomsTariffNumbers { get; set; }
    ...
    public DbSet<AssetMovementItem> AssetMovementItems { get; set; }
    public DbSet<AssetRepair> AssetRepairs { get; set; }
    public DbSet<AssetRepairConsumedItem> AssetRepairConsumedItems { get; set; }
    public DbSet<AssetRepairPurchaseInvoice> AssetRepairPurchaseInvoices { get; set; }
    public DbSet<AssetCapitalization> AssetCapitalizations { get; set; }
    public DbSet<AssetCapitalizationItem> AssetCapitalizationItems { get; set; }
    public DbSet<AssetCapitalizationAsset> AssetCapitalizationAssets { get; set; }
    ...
    public DbSet<BomSecondaryItem> BomSecondaryItems { get; set; }
    ...
    public DbSet<BomCreatorItem> BomCreatorItems { get; set; }

    // Sales (additional)
    public DbSet<PricingRule> PricingRules { get; set; }
    public DbSet<PromotionalScheme> PromotionalSchemes { get; set; }
    public DbSet<PromotionalSchemeTarget> PromotionalSchemeTargets { get; set; }
    public DbSet<PromotionalSchemeParty> PromotionalSchemeParties { get; set; }
    public DbSet<PromotionalSchemePriceDiscountSlab> PromotionalSchemePriceDiscountSlabs { get; set; }
    public DbSet<PromotionalSchemeProductDiscountSlab> PromotionalSchemeProductDiscountSlabs { get; set; }
    ...
    public DbSet<QualityGoalObjective> QualityGoalObjectives { get; set; }
    public DbSet<QualityReview> QualityReviews { get; set; }
    public DbSet<QualityReviewObjective> QualityReviewObjectives { get; set; }
    public DbSet<QualityAction> QualityActions { get; set; }
    public DbSet<QualityActionResolution> QualityActionResolutions { get; set; }
    public DbSet<NonConformance> NonConformances { get; set; }
    public DbSet<QualityMeeting> QualityMeetings { get; set; }
    public DbSet<QualityMeetingAgenda> QualityMeetingAgendas { get; set; }
    public DbSet<QualityMeetingMinutes> QualityMeetingMinutes { get; set; }
    public DbSet<QualityFeedbackTemplate> QualityFeedbackTemplates { get; set; }
    public DbSet<QualityFeedbackTemplateParameter> QualityFeedbackTemplateParameters { get; set; }
    ...
    public DbSet<ShipmentDeliveryNote> ShipmentDeliveryNotes { get; set; }
    ...
    protected override void OnModelCreating(ModelBuilder builder)
    {
        ...
        {
            b.ToTable(MyERPConsts.DbTablePrefix + "CompanyRestrictionEntries", MyERPConsts.DbSchema);
            b.ConfigureByConvention();
            b.Property(x => x.ParentType).IsRequired().HasMaxLength(50);
            b.HasIndex(x => new { x.TenantId, x.ParentType, x.ParentId, x.CompanyId }).IsUnique();
            b.HasIndex(x => new { x.TenantId, x.ParentId });
        });
        ...
        builder.Entity<WarehouseAccount>(b =>
        {
            b.ToTable("Inv_WarehouseAccounts", MyERPConsts.DbSchema);
            b.ConfigureByConvention();
            b.HasOne<Warehouse>().WithMany().HasForeignKey(x => x.WarehouseId).IsRequired();
            b.HasOne<Company>().WithMany().HasForeignKey(x => x.CompanyId).IsRequired();
            b.HasIndex(x => new { x.TenantId, x.WarehouseId, x.CompanyId }).IsUnique();
        });

        builder.Entity<Uom>(b =>
        {
            b.ToTable("Inv_Uoms", MyERPConsts.DbSchema);
            b.ConfigureByConvention();
        ...
        builder.Entity<ItemDefault>(b =>
        {
            b.ToTable("Inv_ItemDefaults", MyERPConsts.DbSchema);
            b.ConfigureByConvention();
            b.Property(x => x.DefaultDiscountPercentage).HasColumnType("decimal(18,4)");
            b.HasOne<Item>().WithMany().HasForeignKey(x => x.ItemId).IsRequired();
            b.HasOne<Company>().WithMany().HasForeignKey(x => x.CompanyId).IsRequired();
            b.HasIndex(x => new { x.TenantId, x.ItemId, x.CompanyId }).IsUnique();
        });

        builder.Entity<PutawayRule>(b =>
        {
            b.ToTable("Inv_PutawayRules", MyERPConsts.DbSchema);
            b.ConfigureByConvention();
            b.Property(x => x.StockCapacity).HasColumnType("decimal(18,4)");
            b.Property(x => x.Uom).HasMaxLength(ItemConsts.MaxUomLength);
            b.HasOne<Warehouse>().WithMany().HasForeignKey(x => x.WarehouseId).IsRequired();
            b.HasIndex(x => new { x.TenantId, x.CompanyId, x.ItemId, x.WarehouseId });
        });
        ...
        builder.Entity<AccountCategory>(b =>
        {
            b.ToTable("Acc_AccountCategories", MyERPConsts.DbSchema);
            b.ConfigureByConvention();
            b.Property(x => x.Name).IsRequired().HasMaxLength(140);
            b.Property(x => x.RootType).IsRequired().HasMaxLength(20);
            b.Property(x => x.Description).HasMaxLength(500);
            b.HasIndex(x => new { x.TenantId, x.Name }).IsUnique();
        });
        ...
        builder.Entity<SalesOrder>(b =>
        {
            ...
            // Optimistic concurrency — protects DeliveredQty/BilledQty from concurrent DN/SI submission
        ...
        builder.Entity<DeliveryScheduleEntry>(b =>
        {
            b.ToTable("Sal_DeliveryScheduleEntries", MyERPConsts.DbSchema);
            b.ConfigureByConvention();
            b.Property(x => x.ScheduledQty).HasColumnType("decimal(18,4)");
            b.Property(x => x.DeliveredQty).HasColumnType("decimal(18,4)");
            b.HasIndex(x => new { x.TenantId, x.SalesOrderId, x.SalesOrderItemId, x.ScheduledDate });
        });
        ...
        builder.Entity<SalesInvoice>(b =>
        {
            ...
            b.Property(x => x.TotalAdvance).HasColumnType("decimal(18,4)");
            b.Property(x => x.WriteOffAmount).HasColumnType("decimal(18,4)");
            b.Property(x => x.RoundedTotal).HasColumnType("decimal(18,4)");
            b.Property(x => x.RoundingAdjustment).HasColumnType("decimal(18,4)");
            b.Property(x => x.BaseRoundedTotal).HasColumnType("decimal(18,4)");
            b.Property(x => x.BaseRoundingAdjustment).HasColumnType("decimal(18,4)");
        ...
        builder.Entity<PurchaseOrder>(b =>
        {
            ...
            // Optimistic concurrency — protects ReceivedQty/BilledQty from concurrent PR/PI submission
            b.Property(x => x.ConcurrencyStamp).IsConcurrencyToken().HasMaxLength(40);
        });
        ...
        {
            b.ToTable("Pur_SubcontractingInwardOrders", MyERPConsts.DbSchema);
            b.ConfigureByConvention();
            b.Property(x => x.OrderNumber).IsRequired().HasMaxLength(50);
            b.Property(x => x.CurrencyCode).IsRequired().HasMaxLength(10);
            b.Property(x => x.ExchangeRate).HasColumnType("decimal(18,6)");
            b.Property(x => x.NetTotal).HasColumnType("decimal(18,4)");
            b.Property(x => x.GrandTotal).HasColumnType("decimal(18,4)");
            b.Property(x => x.PerReceived).HasColumnType("decimal(18,2)");
            b.Property(x => x.PerBilled).HasColumnType("decimal(18,2)");
            b.HasOne<Company>().WithMany().HasForeignKey(x => x.CompanyId).IsRequired();
            b.HasMany(x => x.Items).WithOne().HasForeignKey(x => x.SubcontractingInwardOrderId).IsRequired();
            b.Navigation(x => x.Items).AutoInclude();
            b.HasIndex(x => new { x.TenantId, x.OrderNumber }).IsUnique();
            b.HasIndex(x => new { x.TenantId, x.CompanyId, x.Status });
        });

        builder.Entity<SubcontractingInwardOrderItem>(b =>
        {
            b.ToTable("Pur_SubcontractingInwardOrderItems", MyERPConsts.DbSchema);
            b.ConfigureByConvention();
            b.Property(x => x.Quantity).HasColumnType("decimal(18,4)");
            b.Property(x => x.Rate).HasColumnType("decimal(18,4)");
            b.Property(x => x.ReceivedQty).HasColumnType("decimal(18,4)");
        ...
        builder.Entity<SerialAndBatchBundle>(b =>
        {
            b.ToTable("Inv_SerialAndBatchBundles", MyERPConsts.DbSchema);
            b.ConfigureByConvention();
            b.Property(x => x.VoucherType).IsRequired().HasMaxLength(64);
            b.Property(x => x.TotalQty).HasColumnType("decimal(18,4)");
            b.Property(x => x.AvgRate).HasColumnType("decimal(18,4)");
            b.Property(x => x.TotalAmount).HasColumnType("decimal(18,4)");
            b.HasOne<Company>().WithMany().HasForeignKey(x => x.CompanyId).IsRequired();
            b.HasMany(x => x.Entries).WithOne().HasForeignKey(x => x.SerialAndBatchBundleId).IsRequired();
            b.Navigation(x => x.Entries).AutoInclude();
            b.HasIndex(x => new { x.TenantId, x.VoucherType, x.VoucherId });
            b.HasIndex(x => new { x.TenantId, x.ItemId, x.WarehouseId, x.TypeOfTransaction });
        });

        builder.Entity<SerialAndBatchEntry>(b =>
        {
        ...
        // Item Standard Cost
        builder.Entity<ItemStandardCost>(b =>
        {
            b.ToTable("Inv_ItemStandardCosts", MyERPConsts.DbSchema);
            b.ConfigureByConvention();
            b.Property(x => x.StandardRate).HasColumnType("decimal(18,4)");
            b.Property(x => x.PreviousRate).HasColumnType("decimal(18,4)");
            b.HasOne<Company>().WithMany().HasForeignKey(x => x.CompanyId).IsRequired();
            b.HasIndex(x => new { x.TenantId, x.ItemId, x.EffectiveDate }).IsUnique();
        });

        // Repost Item Valuation
        builder.Entity<RepostItemValuation>(b =>
        {
            b.ToTable("Inv_RepostItemValuations", MyERPConsts.DbSchema);
            b.ConfigureByConvention();
            b.Property(x => x.VoucherType).HasMaxLength(64);
            b.Property(x => x.ErrorLog).HasMaxLength(4000);
            b.Property(x => x.ItemsToBeReposted).HasMaxLength(4000);
            b.HasOne<Company>().WithMany().HasForeignKey(x => x.CompanyId).IsRequired();
            b.HasIndex(x => new { x.TenantId, x.CompanyId, x.Status });
        ...
        builder.Entity<PaymentEntry>(b =>
        {
            ...
            b.HasMany(x => x.Taxes).WithOne().HasForeignKey(x => x.PaymentEntryId).IsRequired();
            b.Navigation(x => x.Taxes).AutoInclude();
        ...
        // Payment Entry Tax
        builder.Entity<PaymentEntryTax>(b =>
        {
            b.ToTable("Acc_PaymentEntryTaxes", MyERPConsts.DbSchema);
            b.ConfigureByConvention();
            b.Property(x => x.Rate).HasColumnType("decimal(18,4)");
            b.Property(x => x.TaxAmount).HasColumnType("decimal(18,4)");
            b.Property(x => x.BaseTaxAmount).HasColumnType("decimal(18,4)");
        ...
        builder.Entity<BankAccount>(b =>
        {
            ...
            b.Property(x => x.PartyType).HasMaxLength(50);
            b.Property(x => x.CurrencyCode).IsRequired().HasMaxLength(10);
            b.Property(x => x.IntegrationId).HasMaxLength(200);
            b.HasOne<Company>().WithMany().HasForeignKey(x => x.CompanyId).IsRequired();
            b.HasOne<Account>().WithMany().HasForeignKey(x => x.AccountId).IsRequired();
        ...
        builder.Entity<CostCenterAllocation>(b =>
        {
            b.ToTable("Acc_CostCenterAllocations", MyERPConsts.DbSchema);
            b.ConfigureByConvention();
            b.HasOne<Company>().WithMany().HasForeignKey(x => x.CompanyId).IsRequired();
            b.HasIndex(x => new { x.TenantId, x.CompanyId, x.MainCostCenterId, x.IsActive });
            b.HasMany(x => x.Entries).WithOne().HasForeignKey(x => x.CostCenterAllocationId).IsRequired();
            b.Navigation(x => x.Entries).AutoInclude();
        });

        builder.Entity<CostCenterAllocationEntry>(b =>
        {
            b.ToTable("Acc_CostCenterAllocationEntries", MyERPConsts.DbSchema);
            b.ConfigureByConvention();
            b.Property(x => x.Percentage).HasColumnType("decimal(18,4)");
            b.HasIndex(x => new { x.TenantId, x.CostCenterAllocationId, x.ChildCostCenterId }).IsUnique();
        });

        builder.Entity<FinancialReportTemplate>(b =>
        {
            b.ToTable("Acc_FinancialReportTemplates", MyERPConsts.DbSchema);
            b.ConfigureByConvention();
            b.Property(x => x.Name).IsRequired().HasMaxLength(200);
            b.Property(x => x.Description).HasMaxLength(500);
            b.HasMany(x => x.Rows).WithOne().HasForeignKey(x => x.FinancialReportTemplateId).IsRequired();
            b.Navigation(x => x.Rows).AutoInclude();
            b.HasIndex(x => new { x.TenantId, x.Name }).IsUnique();
            b.HasIndex(x => new { x.TenantId, x.CompanyId, x.ReportType, x.IsEnabled });
        });

        builder.Entity<FinancialReportRow>(b =>
        {
            b.ToTable("Acc_FinancialReportRows", MyERPConsts.DbSchema);
            b.ConfigureByConvention();
            b.Property(x => x.Label).IsRequired().HasMaxLength(200);
            b.Property(x => x.ReferenceCode).HasMaxLength(50);
            b.Property(x => x.CalculationFormula).HasMaxLength(1000);
            b.Property(x => x.AccountCategoryFilter).HasMaxLength(200);
            b.Property(x => x.CustomApiPath).HasMaxLength(500);
        });
        ...
        builder.Entity<StockEntry>(b =>
        {
            ...
            b.Navigation(x => x.Items).AutoInclude();
            b.HasIndex(x => new { x.TenantId, x.CompanyId, x.EntryNumber }).IsUnique().HasFilter("\"EntryNumber\" IS NOT NULL");
            b.HasIndex(x => new { x.TenantId, x.CompanyId, x.EntryType, x.Status });
        });
        ...
        builder.Entity<StockLedgerEntry>(b =>
        {
            ...
            b.Property(x => x.StockValueDifference).HasColumnType("decimal(18,4)");
            b.Property(x => x.BalanceQuantity).HasColumnType("decimal(18,4)");
            b.Property(x => x.BalanceValue).HasColumnType("decimal(18,4)");
            b.Property(x => x.IncomingRate).HasColumnType("decimal(18,6)");
            b.Property(x => x.OutgoingRate).HasColumnType("decimal(18,6)");
            b.Property(x => x.VoucherType).HasMaxLength(50);
            b.Property(x => x.StockUom).HasMaxLength(50);
            b.Property(x => x.FiscalYear).HasMaxLength(20);
            b.HasOne<Item>().WithMany().HasForeignKey(x => x.ItemId).IsRequired();
            b.HasOne<Warehouse>().WithMany().HasForeignKey(x => x.WarehouseId).IsRequired();
            b.HasOne<Company>().WithMany().HasForeignKey(x => x.CompanyId).IsRequired();
            // Per gotcha #1246: critical index for stock balance/valuation queries
            b.HasIndex(x => new { x.TenantId, x.ItemId, x.WarehouseId, x.PostingDateTime, x.CreationTime })
                .HasFilter("\"IsCancelled\" = false");
            b.HasIndex(x => new { x.TenantId, x.CompanyId, x.PostingDateTime });
            b.HasIndex(x => new { x.TenantId, x.VoucherType, x.VoucherId });
        });
        ...
        {
            b.ToTable("Hr_Designations", MyERPConsts.DbSchema);
            b.ConfigureByConvention();
            b.Property(x => x.Name).IsRequired().HasMaxLength(200);
            b.Property(x => x.Description).HasMaxLength(2000);
            b.HasIndex(x => new { x.TenantId, x.Name }).IsUnique();
        ...
        builder.Entity<Asset>(b =>
        {
            ...
            b.HasMany(x => x.DepreciationDetails).WithOne().HasForeignKey(x => x.AssetId).IsRequired();
            b.Navigation(x => x.DepreciationDetails).AutoInclude();
        ...
        // Asset Depreciation Detail (per-finance-book settings)
        builder.Entity<AssetDepreciationDetail>(b =>
        {
            b.ToTable("Ast_DepreciationDetails", MyERPConsts.DbSchema);
            b.ConfigureByConvention();
            b.Property(x => x.Rate).HasColumnType("decimal(18,4)");
            b.Property(x => x.NetPurchaseAmount).HasColumnType("decimal(18,2)");
            b.Property(x => x.OpeningAccumulatedDepreciation).HasColumnType("decimal(18,2)");
            b.Property(x => x.ValueAfterDepreciation).HasColumnType("decimal(18,2)");
            b.Property(x => x.ExpectedValueAfterUsefulLife).HasColumnType("decimal(18,2)");
            b.HasIndex(x => new { x.AssetId, x.FinanceBookId });
        });
        ...
        builder.Entity<BillOfMaterials>(b =>
        {
            ...
            b.Property(x => x.ProcessLossPercentage).HasColumnType("decimal(18,4)");
            b.HasMany(x => x.Items).WithOne().HasForeignKey(x => x.BomId).IsRequired();
            b.Navigation(x => x.Items).AutoInclude();
            b.HasMany(x => x.Operations).WithOne().HasForeignKey(x => x.BomId).IsRequired();
            b.Navigation(x => x.Operations).AutoInclude();
            b.HasMany(x => x.SecondaryItems).WithOne().HasForeignKey(x => x.BomId).IsRequired();
        ...
        {
            b.ToTable("Mfg_BOMOperations", MyERPConsts.DbSchema);
            b.ConfigureByConvention();
        ...
        builder.Entity<BomSecondaryItem>(b =>
        {
            b.ToTable("Mfg_BOMSecondaryItems", MyERPConsts.DbSchema);
            b.ConfigureByConvention();
            b.Property(x => x.ItemName).HasMaxLength(200);
            b.Property(x => x.StockUom).HasMaxLength(20);
            b.Property(x => x.Quantity).HasColumnType("decimal(18,4)");
            b.Property(x => x.Rate).HasColumnType("decimal(18,4)");
            b.Property(x => x.CostAllocationPercentage).HasColumnType("decimal(18,4)");
            b.Property(x => x.ProcessLossPercentage).HasColumnType("decimal(18,4)");
            b.HasIndex(x => new { x.BomId, x.ItemId });
        });
        ...
        builder.Entity<PricingRule>(b =>
        {
            ...
            b.HasIndex(x => x.PromotionalSchemeId);
        });

        // Promotional Scheme
        builder.Entity<PromotionalScheme>(b =>
        {
            b.ToTable("Sal_PromotionalSchemes", MyERPConsts.DbSchema);
            b.ConfigureByConvention();
            b.Property(x => x.Title).IsRequired().HasMaxLength(140);
            b.HasOne<Company>().WithMany().HasForeignKey(x => x.CompanyId).IsRequired();
            b.HasMany(x => x.Targets).WithOne().HasForeignKey(x => x.PromotionalSchemeId).IsRequired();
            b.Navigation(x => x.Targets).AutoInclude();
            b.HasMany(x => x.Parties).WithOne().HasForeignKey(x => x.PromotionalSchemeId).IsRequired();
            b.Navigation(x => x.Parties).AutoInclude();
            b.HasMany(x => x.PriceDiscountSlabs).WithOne().HasForeignKey(x => x.PromotionalSchemeId).IsRequired();
            b.Navigation(x => x.PriceDiscountSlabs).AutoInclude();
            b.HasMany(x => x.ProductDiscountSlabs).WithOne().HasForeignKey(x => x.PromotionalSchemeId).IsRequired();
            b.Navigation(x => x.ProductDiscountSlabs).AutoInclude();
            b.HasIndex(x => new { x.TenantId, x.CompanyId, x.IsDisabled });
        });

        builder.Entity<PromotionalSchemeTarget>(b =>
        {
            b.ToTable("Sal_PromotionalSchemeTargets", MyERPConsts.DbSchema);
            b.ConfigureByConvention();
            b.Property(x => x.TargetName).HasMaxLength(200);
        });

        builder.Entity<PromotionalSchemeParty>(b =>
        {
            b.ToTable("Sal_PromotionalSchemeParties", MyERPConsts.DbSchema);
            b.ConfigureByConvention();
            b.Property(x => x.PartyName).HasMaxLength(200);
        });

        builder.Entity<PromotionalSchemePriceDiscountSlab>(b =>
        {
            b.ToTable("Sal_PromotionalSchemePriceDiscountSlabs", MyERPConsts.DbSchema);
            b.ConfigureByConvention();
            b.Property(x => x.Description).HasMaxLength(200);
            b.Property(x => x.DiscountPercentage).HasColumnType("decimal(18,4)");
            b.Property(x => x.DiscountAmount).HasColumnType("decimal(18,2)");
        ...
        builder.Entity<PromotionalSchemeProductDiscountSlab>(b =>
        {
            b.ToTable("Sal_PromotionalSchemeProductDiscountSlabs", MyERPConsts.DbSchema);
            b.ConfigureByConvention();
            b.Property(x => x.Description).HasMaxLength(200);
            b.Property(x => x.FreeQty).HasColumnType("decimal(18,4)");
            b.Property(x => x.FreeItemRate).HasColumnType("decimal(18,2)");
            b.Property(x => x.MinQty).HasColumnType("decimal(18,4)");
            b.Property(x => x.MaxQty).HasColumnType("decimal(18,4)");
            b.Property(x => x.MinAmount).HasColumnType("decimal(18,2)");
            b.Property(x => x.MaxAmount).HasColumnType("decimal(18,2)");
            b.Property(x => x.RecurseFor).HasColumnType("decimal(18,4)");
            b.HasOne<Item>().WithMany().HasForeignKey(x => x.FreeItemId).IsRequired();
        });
        ...
        builder.Entity<SalesPartner>(b =>
        {
            b.ToTable("Sal_SalesPartners", MyERPConsts.DbSchema);
            b.ConfigureByConvention();
            b.Property(x => x.Name).IsRequired().HasMaxLength(SalesPartnerConsts.MaxNameLength);
            b.Property(x => x.CommissionRate).HasColumnType("decimal(5,2)");
        ...
        {
            b.ToTable("Mnt_WarrantyClaims", MyERPConsts.DbSchema);
            b.ConfigureByConvention();
            b.Property(x => x.ClaimNumber).IsRequired().HasMaxLength(WarrantyClaimConsts.MaxClaimNumberLength);
            b.Property(x => x.Complaint).HasMaxLength(WarrantyClaimConsts.MaxComplaintLength);
            b.Property(x => x.Resolution).HasMaxLength(WarrantyClaimConsts.MaxResolutionLength);
            b.HasOne<Company>().WithMany().HasForeignKey(x => x.CompanyId).IsRequired();
            b.HasIndex(x => new { x.TenantId, x.CompanyId, x.CustomerId, x.Status });
        });
        ...
        // Downtime Entry
        builder.Entity<DowntimeEntry>(b =>
        {
            b.ToTable("Mfg_DowntimeEntries", MyERPConsts.DbSchema);
            b.ConfigureByConvention();
            b.Property(x => x.StopReason).IsRequired().HasMaxLength(100);
            b.Property(x => x.Remarks).HasMaxLength(2000);
            b.Property(x => x.DowntimeMinutes).HasColumnType("decimal(18,2)");
            b.HasOne<Workstation>().WithMany().HasForeignKey(x => x.WorkstationId).IsRequired();
            b.HasOne<Company>().WithMany().HasForeignKey(x => x.CompanyId).IsRequired();
            b.HasIndex(x => new { x.TenantId, x.WorkstationId, x.FromTime });
        });

        // BOM Creator
        builder.Entity<BomCreator>(b =>
        {
            b.ToTable("Mfg_BomCreators", MyERPConsts.DbSchema);
            b.ConfigureByConvention();
            b.Property(x => x.Uom).HasMaxLength(50);
            b.Property(x => x.RmCostAsPer).IsRequired().HasMaxLength(30);
            b.Property(x => x.Remarks).HasMaxLength(2000);
            b.Property(x => x.ErrorLog).HasMaxLength(4000);
            b.Property(x => x.Qty).HasColumnType("decimal(18,4)");
            b.Property(x => x.RawMaterialCost).HasColumnType("decimal(18,2)");
            b.HasOne<Item>().WithMany().HasForeignKey(x => x.FinishedGoodItemId).IsRequired();
            b.HasOne<Company>().WithMany().HasForeignKey(x => x.CompanyId).IsRequired();
            b.HasMany(x => x.Items).WithOne().HasForeignKey(x => x.BomCreatorId).IsRequired();
            b.Navigation(x => x.Items).AutoInclude();
        });

        builder.Entity<BomCreatorItem>(b =>
        {
            b.ToTable("Mfg_BomCreatorItems", MyERPConsts.DbSchema);
            b.ConfigureByConvention();
            b.Property(x => x.ItemName).IsRequired().HasMaxLength(200);
            b.Property(x => x.Uom).HasMaxLength(50);
            b.Property(x => x.StockUom).IsRequired().HasMaxLength(50);
            b.Property(x => x.Instruction).HasMaxLength(1000);
            b.Property(x => x.Qty).HasColumnType("decimal(18,4)");
            b.Property(x => x.Rate).HasColumnType("decimal(18,2)");
        ...
        // POS Opening Entry
        builder.Entity<PosOpeningEntry>(b =>
        {
            b.ToTable("Sal_PosOpeningEntries", MyERPConsts.DbSchema);
            b.ConfigureByConvention();
            b.HasOne<Company>().WithMany().HasForeignKey(x => x.CompanyId).IsRequired();
            b.HasMany(x => x.Payments).WithOne().HasForeignKey(x => x.PosOpeningEntryId).IsRequired();
            b.Navigation(x => x.Payments).AutoInclude();
            b.HasIndex(x => new { x.TenantId, x.CompanyId, x.PosProfileId, x.Status });
            b.HasIndex(x => new { x.TenantId, x.UserId, x.Status });
        });

        builder.Entity<PosOpeningPayment>(b =>
        {
            b.ToTable("Sal_PosOpeningPayments", MyERPConsts.DbSchema);
            b.ConfigureByConvention();
            b.Property(x => x.ModeName).IsRequired().HasMaxLength(100);
        ...
        // POS Profile
        builder.Entity<PosProfile>(b =>
        {
            b.ToTable("Sal_PosProfiles", MyERPConsts.DbSchema);
            b.ConfigureByConvention();
            b.Property(x => x.ProfileName).IsRequired().HasMaxLength(140);
            b.Property(x => x.CurrencyCode).IsRequired().HasMaxLength(10);
        ...
        builder.Entity<PosProfilePaymentMethod>(b =>
        {
        ...
        // Installation Note
        builder.Entity<InstallationNote>(b =>
        {
            b.ToTable("Sal_InstallationNotes", MyERPConsts.DbSchema);
            b.ConfigureByConvention();
            b.Property(x => x.InstallationNumber).IsRequired().HasMaxLength(50);
            b.Property(x => x.Remarks).HasMaxLength(2000);
            b.HasOne<Customer>().WithMany().HasForeignKey(x => x.CustomerId).IsRequired();
            b.HasOne<DeliveryNote>().WithMany().HasForeignKey(x => x.DeliveryNoteId).IsRequired();
            b.HasMany(x => x.Items).WithOne().IsRequired();
            b.Navigation(x => x.Items).AutoInclude();
            b.HasIndex(x => new { x.TenantId, x.CompanyId, x.DeliveryNoteId });
        });

        builder.Entity<InstallationNoteItem>(b =>
        {
            b.ToTable("Sal_InstallationNoteItems", MyERPConsts.DbSchema);
            b.ConfigureByConvention();
            b.Property(x => x.Qty).HasColumnType("decimal(18,4)");
        ...
        builder.Entity<PartyLink>(b =>
        {
            b.ToTable(MyERPConsts.DbTablePrefix + "PartyLinks", MyERPConsts.DbSchema);
            b.ConfigureByConvention();
            b.Property(x => x.PrimaryPartyType).IsRequired().HasMaxLength(64);
            b.Property(x => x.SecondaryPartyType).IsRequired().HasMaxLength(64);
            b.HasIndex(x => new { x.TenantId, x.PrimaryPartyType, x.PrimaryPartyId }).IsUnique();
            b.HasIndex(x => new { x.TenantId, x.SecondaryPartyType, x.SecondaryPartyId }).IsUnique();
        });

        // CouponCode — promotional/gift card codes linked to Pricing Rules
        builder.Entity<CouponCode>(b =>
        {
            b.ToTable("Sal_CouponCodes", MyERPConsts.DbSchema);
            b.ConfigureByConvention();
            b.Property(x => x.Code).IsRequired().HasMaxLength(50);
            b.Property(x => x.CouponName).IsRequired().HasMaxLength(200);
            b.Property(x => x.Description).HasMaxLength(500);
            b.HasIndex(x => new { x.TenantId, x.Code }).IsUnique();
        });

        // CustomerCreditLimit — per-company credit limits
        builder.Entity<CustomerCreditLimit>(b =>
        {
            b.ToTable("Sal_CustomerCreditLimits", MyERPConsts.DbSchema);
            b.ConfigureByConvention();
            b.Property(x => x.CreditLimit).HasColumnType("decimal(18,4)");
            b.Property(x => x.OverdueBillingThreshold).HasColumnType("decimal(18,4)");
            b.HasIndex(x => new { x.TenantId, x.CustomerId, x.CompanyId }).IsUnique();
        });

        // PackingSlip — case packing for Delivery Notes
        builder.Entity<PackingSlip>(b =>
        {
            b.ToTable("Sal_PackingSlips", MyERPConsts.DbSchema);
            b.ConfigureByConvention();
            b.Property(x => x.NetWeight).HasColumnType("decimal(18,4)");
            b.Property(x => x.GrossWeight).HasColumnType("decimal(18,4)");
            b.Property(x => x.WeightUom).HasMaxLength(50);
            b.HasMany(x => x.Items).WithOne().HasForeignKey(x => x.PackingSlipId).IsRequired();
            b.Navigation(x => x.Items).AutoInclude();
            b.HasIndex(x => new { x.TenantId, x.DeliveryNoteId });
        });

        builder.Entity<PackingSlipItem>(b =>
        {
            b.ToTable("Sal_PackingSlipItems", MyERPConsts.DbSchema);
            b.ConfigureByConvention();
            b.Property(x => x.Qty).HasColumnType("decimal(18,4)");
            b.Property(x => x.NetWeight).HasColumnType("decimal(18,4)");
            b.Property(x => x.Description).HasMaxLength(500);
        ...
        builder.Entity<ProformaInvoice>(b =>
        {
            b.ToTable("Sal_ProformaInvoices", MyERPConsts.DbSchema);
            b.ConfigureByConvention();
            b.Property(x => x.ProformaNumber).HasMaxLength(128).IsRequired();
            b.Property(x => x.CurrencyCode).HasMaxLength(10);
            b.Property(x => x.GrandTotal).HasColumnType("decimal(18,4)");
            b.Property(x => x.TotalQty).HasColumnType("decimal(18,4)");
            b.Property(x => x.ProformaPdfUrl).HasMaxLength(512);
            b.Property(x => x.EmailedTo).HasMaxLength(1000);
            b.HasMany(x => x.Items).WithOne().HasForeignKey(x => x.ProformaInvoiceId).IsRequired();
            b.Navigation(x => x.Items).AutoInclude();
            b.HasIndex(x => new { x.TenantId, x.SalesOrderId, x.Status });
        });

        builder.Entity<ProformaInvoiceItem>(b =>
        {
            b.ToTable("Sal_ProformaInvoiceItems", MyERPConsts.DbSchema);
            b.ConfigureByConvention();
        ...
        // ═══════════════════════════════════════════════════
        builder.Entity<QualityInspectionTemplate>(b =>
        {
        ...
        builder.Entity<QualityInspectionParameter>(b =>
        {
            b.ToTable("Inv_QualityInspectionParameters", MyERPConsts.DbSchema);
            b.ConfigureByConvention();
            b.Property(x => x.Specification).HasMaxLength(200).IsRequired();
            b.Property(x => x.ExpectedValue).HasMaxLength(200);
            b.Property(x => x.MinValue).HasColumnType("decimal(18,6)");
            b.Property(x => x.MaxValue).HasColumnType("decimal(18,6)");
            b.Property(x => x.Formula).HasMaxLength(500);
        ...
        {
            b.ToTable("Inv_QualityProcedures", MyERPConsts.DbSchema);
            b.ConfigureByConvention();
            b.Property(x => x.Name).HasMaxLength(200).IsRequired();
            b.Property(x => x.Description).HasMaxLength(2000);
            b.HasMany(x => x.Steps).WithOne().HasForeignKey(x => x.QualityProcedureId).IsRequired();
            b.Navigation(x => x.Steps).AutoInclude();
            b.HasIndex(x => new { x.TenantId, x.ParentQualityProcedureId });
            b.HasIndex(x => new { x.TenantId, x.Lft, x.Rgt });
        });

        builder.Entity<QualityProcedureStep>(b =>
        {
            b.ToTable("Inv_QualityProcedureSteps", MyERPConsts.DbSchema);
            b.ConfigureByConvention();
            b.Property(x => x.Description).HasMaxLength(500).IsRequired();
        });

        builder.Entity<QualityGoal>(b =>
        {
            b.ToTable("Inv_QualityGoals", MyERPConsts.DbSchema);
            b.ConfigureByConvention();
            b.Property(x => x.Name).HasMaxLength(200).IsRequired();
            b.Property(x => x.Goal).HasMaxLength(500);
            b.Property(x => x.Frequency).HasMaxLength(50).IsRequired();
            b.Property(x => x.TargetValue).HasColumnType("decimal(18,4)");
            b.Property(x => x.Uom).HasMaxLength(50);
            b.Property(x => x.Weekday).HasMaxLength(20);
            b.HasMany(x => x.Objectives).WithOne().HasForeignKey(x => x.QualityGoalId).IsRequired();
            b.Navigation(x => x.Objectives).AutoInclude();
            b.HasIndex(x => new { x.TenantId, x.IsEnabled });
        });

        builder.Entity<QualityGoalObjective>(b =>
        {
            b.ToTable("Inv_QualityGoalObjectives", MyERPConsts.DbSchema);
            b.ConfigureByConvention();
            b.Property(x => x.Objective).HasMaxLength(200).IsRequired();
            b.Property(x => x.Target).HasColumnType("decimal(18,4)");
            b.Property(x => x.Uom).HasMaxLength(50);
        });

        builder.Entity<QualityReview>(b =>
        {
            b.ToTable("Inv_QualityReviews", MyERPConsts.DbSchema);
            b.ConfigureByConvention();
            b.Property(x => x.Notes).HasMaxLength(1000);
            b.Property(x => x.ActualValue).HasColumnType("decimal(18,4)");
            b.HasMany(x => x.Objectives).WithOne().HasForeignKey(x => x.QualityReviewId).IsRequired();
            b.Navigation(x => x.Objectives).AutoInclude();
            b.HasOne<QualityGoal>().WithMany().HasForeignKey(x => x.QualityGoalId).IsRequired();
            b.HasIndex(x => new { x.TenantId, x.QualityGoalId, x.ReviewDate });
        });

        builder.Entity<QualityReviewObjective>(b =>
        {
            b.ToTable("Inv_QualityReviewObjectives", MyERPConsts.DbSchema);
            b.ConfigureByConvention();
            b.Property(x => x.Objective).HasMaxLength(200).IsRequired();
            b.Property(x => x.Target).HasColumnType("decimal(18,4)");
            b.Property(x => x.Actual).HasColumnType("decimal(18,4)");
            b.Property(x => x.Uom).HasMaxLength(50);
            b.Property(x => x.Notes).HasMaxLength(1000);
        });
        ...
        {
            b.ToTable("Inv_QualityActions", MyERPConsts.DbSchema);
            b.ConfigureByConvention();
            b.Property(x => x.ProblemDescription).IsRequired().HasMaxLength(2000);
            b.Property(x => x.Resolution).HasMaxLength(4000);
            b.HasMany(x => x.Resolutions).WithOne().HasForeignKey(x => x.QualityActionId).IsRequired();
            b.Navigation(x => x.Resolutions).AutoInclude();
            b.HasIndex(x => new { x.TenantId, x.CompanyId, x.Status });
        });

        builder.Entity<QualityActionResolution>(b =>
        {
            b.ToTable("Inv_QualityActionResolutions", MyERPConsts.DbSchema);
            b.ConfigureByConvention();
            b.Property(x => x.Problem).IsRequired().HasMaxLength(2000);
            b.Property(x => x.ResolutionDetails).IsRequired().HasMaxLength(4000);
        });

        builder.Entity<NonConformance>(b =>
        {
            b.ToTable("Inv_NonConformances", MyERPConsts.DbSchema);
            b.ConfigureByConvention();
            b.Property(x => x.Subject).IsRequired().HasMaxLength(250);
            b.Property(x => x.ProcessOwner).HasMaxLength(200);
            b.Property(x => x.Details).HasMaxLength(4000);
            b.Property(x => x.CorrectiveAction).HasMaxLength(4000);
            b.Property(x => x.PreventiveAction).HasMaxLength(4000);
            b.HasIndex(x => new { x.TenantId, x.CompanyId, x.Status });
            b.HasIndex(x => new { x.TenantId, x.ProcedureId });
        });

        builder.Entity<QualityMeeting>(b =>
        {
            b.ToTable("Inv_QualityMeetings", MyERPConsts.DbSchema);
            b.ConfigureByConvention();
            b.Property(x => x.Chairperson).HasMaxLength(150);
            b.Property(x => x.Attendees).HasMaxLength(2000);
            b.HasMany(x => x.Agendas).WithOne().HasForeignKey(x => x.QualityMeetingId).IsRequired();
            b.HasMany(x => x.Minutes).WithOne().HasForeignKey(x => x.QualityMeetingId).IsRequired();
            b.Navigation(x => x.Agendas).AutoInclude();
            b.Navigation(x => x.Minutes).AutoInclude();
            b.HasIndex(x => new { x.TenantId, x.CompanyId, x.Status });
            b.HasIndex(x => new { x.TenantId, x.CompanyId, x.MeetingDate });
        });

        builder.Entity<QualityMeetingAgenda>(b =>
        {
            b.ToTable("Inv_QualityMeetingAgendas", MyERPConsts.DbSchema);
            b.ConfigureByConvention();
            b.Property(x => x.Agenda).IsRequired().HasMaxLength(2000);
        });

        builder.Entity<QualityMeetingMinutes>(b =>
        {
            b.ToTable("Inv_QualityMeetingMinutes", MyERPConsts.DbSchema);
            b.ConfigureByConvention();
            b.Property(x => x.Discussion).IsRequired().HasMaxLength(4000);
            b.Property(x => x.ActionPlan).HasMaxLength(4000);
        });

        builder.Entity<QualityFeedbackTemplate>(b =>
        {
            b.ToTable("Inv_QualityFeedbackTemplates", MyERPConsts.DbSchema);
            b.ConfigureByConvention();
            b.Property(x => x.TemplateName).IsRequired().HasMaxLength(200);
            b.HasMany(x => x.Parameters).WithOne().HasForeignKey(x => x.QualityFeedbackTemplateId).IsRequired();
            b.Navigation(x => x.Parameters).AutoInclude();
            b.HasIndex(x => new { x.TenantId, x.TemplateName });
        });

        builder.Entity<QualityFeedbackTemplateParameter>(b =>
        {
            b.ToTable("Inv_QualityFeedbackTemplateParameters", MyERPConsts.DbSchema);
            b.ConfigureByConvention();
            b.Property(x => x.Parameter).IsRequired().HasMaxLength(200);
        });

        builder.Entity<QualityFeedback>(b =>
        {
            b.ToTable("Inv_QualityFeedbacks", MyERPConsts.DbSchema);
            b.ConfigureByConvention();
            b.Property(x => x.DocumentName).IsRequired().HasMaxLength(200);
            b.Property(x => x.Remarks).HasMaxLength(1000);
            b.HasMany(x => x.Parameters).WithOne().HasForeignKey(x => x.QualityFeedbackId).IsRequired();
            b.Navigation(x => x.Parameters).AutoInclude();
            b.HasIndex(x => new { x.TenantId, x.CompanyId, x.TemplateId });
        });

        builder.Entity<QualityFeedbackParameter>(b =>
        {
            b.ToTable("Inv_QualityFeedbackParameters", MyERPConsts.DbSchema);
            b.ConfigureByConvention();
            b.Property(x => x.Parameter).IsRequired().HasMaxLength(200);
            b.Property(x => x.Remarks).HasMaxLength(1000);
        });
        ...
        {
            b.ToTable("CRM_Prospects", MyERPConsts.DbSchema);
            b.ConfigureByConvention();
            b.Property(x => x.ProspectName).HasMaxLength(200).IsRequired();
            ...
            b.Property(x => x.Territory).HasMaxLength(100);
            b.Property(x => x.CustomerGroup).HasMaxLength(100);
            b.Property(x => x.AnnualRevenue).HasColumnType("decimal(18,4)");
            b.Property(x => x.Notes).HasMaxLength(2000);
            b.HasMany(x => x.Leads).WithOne().HasForeignKey(x => x.ProspectId).IsRequired();
            b.HasMany(x => x.Opportunities).WithOne().HasForeignKey(x => x.ProspectId).IsRequired();
            b.Navigation(x => x.Leads).AutoInclude();
            b.Navigation(x => x.Opportunities).AutoInclude();
            b.HasIndex(x => new { x.TenantId, x.CompanyId });
        });

        builder.Entity<ProspectLead>(b =>
        {
            b.ToTable("CRM_ProspectLeads", MyERPConsts.DbSchema);
            b.ConfigureByConvention();
        ...
        builder.Entity<ProspectOpportunity>(b =>
        {
            b.ToTable("CRM_ProspectOpportunities", MyERPConsts.DbSchema);
            b.ConfigureByConvention();
            b.Property(x => x.OpportunityName).HasMaxLength(200);
            b.Property(x => x.Amount).HasColumnType("decimal(18,4)");
        });
        ...
        {
            b.ToTable("CRM_Contracts", MyERPConsts.DbSchema);
            b.ConfigureByConvention();
            b.Property(x => x.ContractNumber).HasMaxLength(128).IsRequired();
            b.Property(x => x.ContractName).HasMaxLength(300);
            b.Property(x => x.PartyType).HasMaxLength(50).IsRequired();
            b.Property(x => x.PartyName).HasMaxLength(200);
            b.Property(x => x.ContractTerms).HasMaxLength(10000);
            b.Property(x => x.IpOwnership).HasMaxLength(200);
        ...
        {
            b.ToTable("Sal_Shipments", MyERPConsts.DbSchema);
            b.ConfigureByConvention();
            b.Property(x => x.ShipmentNumber).HasMaxLength(128).IsRequired();
            b.Property(x => x.PickupFromType).HasMaxLength(50);
            b.Property(x => x.PickupFromName).HasMaxLength(200);
            b.Property(x => x.PickupContactName).HasMaxLength(200);
            b.Property(x => x.PickupContactPhone).HasMaxLength(50);
            b.Property(x => x.DeliveryToType).HasMaxLength(50);
            b.Property(x => x.DeliveryToName).HasMaxLength(200);
            b.Property(x => x.DeliveryContactName).HasMaxLength(200);
            b.Property(x => x.DeliveryContactPhone).HasMaxLength(50);
            b.Property(x => x.Carrier).HasMaxLength(100);
            b.Property(x => x.CarrierService).HasMaxLength(100);
            b.Property(x => x.TrackingNumber).HasMaxLength(200);
            b.Property(x => x.TrackingUrl).HasMaxLength(500);
            b.Property(x => x.TotalNetWeight).HasColumnType("decimal(18,4)");
            b.Property(x => x.TotalGrossWeight).HasColumnType("decimal(18,4)");
            b.Property(x => x.WeightUom).HasMaxLength(20);
            b.Property(x => x.ValueOfGoods).HasColumnType("decimal(18,4)");
            b.Property(x => x.CurrencyCode).HasMaxLength(10);
            b.Property(x => x.Notes).HasMaxLength(2000);
            b.HasMany(x => x.DeliveryNotes).WithOne().HasForeignKey(x => x.ShipmentId).IsRequired();
            b.Navigation(x => x.DeliveryNotes).AutoInclude();
            b.HasIndex(x => new { x.TenantId, x.CompanyId, x.Status });
        });

        builder.Entity<ShipmentDeliveryNote>(b =>
        {
            b.ToTable("Sal_ShipmentDeliveryNotes", MyERPConsts.DbSchema);
            b.ConfigureByConvention();
        ...
        {
            b.ToTable("Acc_BankGuarantees", MyERPConsts.DbSchema);
            b.ConfigureByConvention();
            b.Property(x => x.ReferenceDocType).HasMaxLength(BankGuaranteeConsts.MaxReferenceDocTypeLength);
            b.Property(x => x.ReferenceDocName).HasMaxLength(BankGuaranteeConsts.MaxReferenceDocNameLength);
            b.Property(x => x.CustomerName).HasMaxLength(BankGuaranteeConsts.MaxBeneficiaryNameLength);
            b.Property(x => x.SupplierName).HasMaxLength(BankGuaranteeConsts.MaxBeneficiaryNameLength);
            b.Property(x => x.ProjectName).HasMaxLength(BankGuaranteeConsts.MaxBeneficiaryNameLength);
            b.Property(x => x.Amount).HasColumnType("decimal(18,4)");
            b.Property(x => x.Bank).HasMaxLength(BankGuaranteeConsts.MaxBankNameLength);
            b.Property(x => x.BankAccountNumber).HasMaxLength(BankGuaranteeConsts.MaxAccountNumberLength);
            b.Property(x => x.Account).HasMaxLength(BankGuaranteeConsts.MaxAccountNumberLength);
            b.Property(x => x.Iban).HasMaxLength(BankGuaranteeConsts.MaxIbanLength);
            b.Property(x => x.BranchCode).HasMaxLength(BankGuaranteeConsts.MaxBranchCodeLength);
            b.Property(x => x.SwiftNumber).HasMaxLength(BankGuaranteeConsts.MaxSwiftNumberLength);
            b.Property(x => x.BankGuaranteeNumber).HasMaxLength(BankGuaranteeConsts.MaxGuaranteeNumberLength);
            b.Property(x => x.NameOfBeneficiary).HasMaxLength(BankGuaranteeConsts.MaxBeneficiaryNameLength);
            b.Property(x => x.MarginMoney).HasColumnType("decimal(18,4)");
            b.Property(x => x.Charges).HasColumnType("decimal(18,4)");
            b.Property(x => x.FixedDepositNumber).HasMaxLength(BankGuaranteeConsts.MaxFixedDepositNumberLength);
            b.Property(x => x.ClausesAndConditions).HasMaxLength(BankGuaranteeConsts.MaxClausesLength);
            b.HasIndex(x => new { x.TenantId, x.CompanyId, x.BankGuaranteeNumber });
            b.HasIndex(x => new { x.TenantId, x.CompanyId, x.Status });
        });

        // Share Management
        builder.Entity<ShareType>(b =>
        {
            b.ToTable("Acc_ShareTypes", MyERPConsts.DbSchema);
            b.ConfigureByConvention();
            b.Property(x => x.Title).IsRequired().HasMaxLength(140);
            b.Property(x => x.Description).HasMaxLength(2000);
        });

        builder.Entity<Shareholder>(b =>
        {
            b.ToTable("Acc_Shareholders", MyERPConsts.DbSchema);
            b.ConfigureByConvention();
            b.Property(x => x.Title).IsRequired().HasMaxLength(200);
            b.Property(x => x.FolioNo).HasMaxLength(50);
            b.HasOne<Company>().WithMany().HasForeignKey(x => x.CompanyId).IsRequired();
            b.HasMany(x => x.ShareBalances).WithOne().HasForeignKey(x => x.ShareholderId).IsRequired();
            b.Navigation(x => x.ShareBalances).AutoInclude();
            b.HasIndex(x => new { x.TenantId, x.CompanyId, x.IsCompany });
        });

        builder.Entity<ShareBalanceEntry>(b =>
        {
            b.ToTable("Acc_ShareBalanceEntries", MyERPConsts.DbSchema);
            b.ConfigureByConvention();
            b.Property(x => x.Rate).HasColumnType("decimal(18,4)");
            b.Property(x => x.CurrentState).HasMaxLength(30);
            b.HasOne<ShareType>().WithMany().HasForeignKey(x => x.ShareTypeId).IsRequired();
        });

        builder.Entity<ShareTransfer>(b =>
        {
            b.ToTable("Acc_ShareTransfers", MyERPConsts.DbSchema);
            b.ConfigureByConvention();
            b.Property(x => x.Rate).HasColumnType("decimal(18,4)");
            b.Property(x => x.Amount).HasColumnType("decimal(18,4)");
            b.Property(x => x.Remarks).HasMaxLength(2000);
        ...
        {
            b.ToTable("Inv_CustomsTariffNumbers", MyERPConsts.DbSchema);
            b.ConfigureByConvention();
            b.Property(x => x.TariffNumber).IsRequired().HasMaxLength(CustomsTariffNumberConsts.MaxTariffNumberLength);
            b.Property(x => x.Description).HasMaxLength(CustomsTariffNumberConsts.MaxDescriptionLength);
            b.HasIndex(x => new { x.TenantId, x.CompanyId, x.TariffNumber }).IsUnique();
        });

        builder.Entity<Manufacturer>(b =>
        {
            b.ToTable("Inv_Manufacturers", MyERPConsts.DbSchema);
            b.ConfigureByConvention();
            b.Property(x => x.ShortName).IsRequired().HasMaxLength(ManufacturerConsts.MaxShortNameLength);
            b.Property(x => x.FullName).HasMaxLength(ManufacturerConsts.MaxFullNameLength);
            b.Property(x => x.Website).HasMaxLength(ManufacturerConsts.MaxWebsiteLength);
            b.Property(x => x.Country).HasMaxLength(ManufacturerConsts.MaxCountryLength);
            b.Property(x => x.LogoUrl).HasMaxLength(ManufacturerConsts.MaxLogoUrlLength);
            b.Property(x => x.Notes).HasMaxLength(ManufacturerConsts.MaxNotesLength);
            b.HasIndex(x => new { x.TenantId, x.CompanyId, x.ShortName }).IsUnique();
        });

        builder.Entity<ItemManufacturer>(b =>
        {
            b.ToTable("Inv_ItemManufacturers", MyERPConsts.DbSchema);
            b.ConfigureByConvention();
            b.Property(x => x.ManufacturerPartNo).IsRequired().HasMaxLength(ItemManufacturerConsts.MaxManufacturerPartNoLength);
            b.Property(x => x.Description).HasMaxLength(ItemManufacturerConsts.MaxDescriptionLength);
            b.HasIndex(x => new { x.TenantId, x.CompanyId, x.ItemId });
            b.HasIndex(x => new { x.TenantId, x.CompanyId, x.ManufacturerId });
            b.HasIndex(x => new { x.TenantId, x.CompanyId, x.ItemId, x.ManufacturerId, x.ManufacturerPartNo });
        });

        builder.Entity<ItemAlternative>(b =>
        {
            b.ToTable("Inv_ItemAlternatives", MyERPConsts.DbSchema);
            b.ConfigureByConvention();
            b.HasIndex(x => new { x.TenantId, x.CompanyId, x.ItemId });
            b.HasIndex(x => new { x.TenantId, x.CompanyId, x.AlternativeItemId });
            b.HasIndex(x => new { x.TenantId, x.CompanyId, x.ItemId, x.AlternativeItemId }).IsUnique();
        });

        builder.Entity<DeliveryTrip>(b =>
        {
            b.ToTable("Inv_DeliveryTrips", MyERPConsts.DbSchema);
            b.ConfigureByConvention();
            b.Property(x => x.NamingSeries).HasMaxLength(DeliveryTripConsts.MaxNamingSeriesLength);
            b.Property(x => x.TripNumber).IsRequired().HasMaxLength(DeliveryTripConsts.MaxTripNumberLength);
            b.Property(x => x.Driver).IsRequired().HasMaxLength(DeliveryTripConsts.MaxDriverNameLength);
            b.Property(x => x.DriverName).HasMaxLength(DeliveryTripConsts.MaxDriverNameLength);
            b.Property(x => x.DriverEmail).HasMaxLength(DeliveryTripConsts.MaxDriverEmailLength);
            b.Property(x => x.DriverAddress).HasMaxLength(DeliveryTripConsts.MaxAddressLength);
            b.Property(x => x.Vehicle).IsRequired().HasMaxLength(DeliveryTripConsts.MaxVehicleLength);
            b.Property(x => x.TotalDistance).HasColumnType("decimal(18,2)");
            b.Property(x => x.Uom).HasMaxLength(DeliveryTripConsts.MaxUomLength);
            b.HasMany(x => x.DeliveryStops)
                .WithOne()
                .HasForeignKey(x => x.DeliveryTripId)
                .IsRequired()
                .OnDelete(Microsoft.EntityFrameworkCore.DeleteBehavior.Cascade);
            b.HasIndex(x => new { x.TenantId, x.CompanyId, x.TripNumber });
            b.HasIndex(x => new { x.TenantId, x.CompanyId, x.Status });
        });

        builder.Entity<DeliveryStop>(b =>
        {
            b.ToTable("Inv_DeliveryStops", MyERPConsts.DbSchema);
            b.ConfigureByConvention();
            b.Property(x => x.Address).IsRequired().HasMaxLength(DeliveryTripConsts.MaxAddressLength);
            b.Property(x => x.CustomerAddress).HasMaxLength(DeliveryTripConsts.MaxAddressLength);
            b.Property(x => x.CustomerName).HasMaxLength(DeliveryTripConsts.MaxDriverNameLength);
            b.Property(x => x.DeliveryNoteNumber).HasMaxLength(50);
            b.Property(x => x.ContactName).HasMaxLength(DeliveryTripConsts.MaxDriverNameLength);
            b.Property(x => x.EmailSentTo).HasMaxLength(DeliveryTripConsts.MaxDriverEmailLength);
            b.Property(x => x.CustomerContact).HasMaxLength(DeliveryTripConsts.MaxDriverNameLength);
            b.Property(x => x.GrandTotal).HasColumnType("decimal(18,4)");
            b.Property(x => x.Distance).HasColumnType("decimal(18,2)");
            b.Property(x => x.Uom).HasMaxLength(DeliveryTripConsts.MaxUomLength);
        ...
        builder.Entity<WarrantyClaim>(b =>
        {
            ...
            b.Property(x => x.Complaint).HasMaxLength(4000);
            b.Property(x => x.Resolution).HasMaxLength(4000);
            b.HasIndex(x => new { x.TenantId, x.CompanyId, x.ClaimNumber });
            b.HasIndex(x => new { x.TenantId, x.CompanyId, x.Status });
            b.HasIndex(x => new { x.TenantId, x.CompanyId, x.CustomerId });
            b.HasIndex(x => new { x.TenantId, x.CompanyId, x.ItemId });
        });

        builder.Entity<AssetMaintenance>(b =>
        {
            b.ToTable("Ast_AssetMaintenances", MyERPConsts.DbSchema);
            b.ConfigureByConvention();
            b.Property(x => x.AssetName).HasMaxLength(AssetMaintenanceConsts.MaxAssetNameLength);
            b.Property(x => x.ItemCode).HasMaxLength(AssetMaintenanceConsts.MaxItemCodeLength);
            b.Property(x => x.ItemName).HasMaxLength(AssetMaintenanceConsts.MaxItemNameLength);
            b.Property(x => x.MaintenanceManagerName).HasMaxLength(AssetMaintenanceConsts.MaxAssignToLength);
            b.Property(x => x.MaintenanceTeamName).HasMaxLength(AssetMaintenanceConsts.MaxMaintenanceNameLength);
            b.HasMany(x => x.Tasks)
                .WithOne()
                .HasForeignKey(x => x.AssetMaintenanceId)
                .IsRequired()
                .OnDelete(Microsoft.EntityFrameworkCore.DeleteBehavior.Cascade);
            b.HasIndex(x => new { x.TenantId, x.CompanyId, x.AssetId });
        });

        builder.Entity<AssetMaintenanceTask>(b =>
        {
            b.ToTable("Ast_AssetMaintenanceTasks", MyERPConsts.DbSchema);
            b.ConfigureByConvention();
            b.Property(x => x.MaintenanceTask).IsRequired().HasMaxLength(AssetMaintenanceConsts.MaxTaskNameLength);
            b.Property(x => x.MaintenanceType).HasMaxLength(AssetMaintenanceConsts.MaxMaintenanceNameLength);
            b.Property(x => x.AssignTo).HasMaxLength(AssetMaintenanceConsts.MaxAssignToLength);
            b.Property(x => x.AssignToName).HasMaxLength(AssetMaintenanceConsts.MaxAssignToLength);
        ...
        {
            b.ToTable("Ast_AssetMaintenanceLogs", MyERPConsts.DbSchema);
            b.ConfigureByConvention();
            b.Property(x => x.MaintenanceTask).IsRequired().HasMaxLength(AssetMaintenanceConsts.MaxTaskNameLength);
            b.Property(x => x.AssetName).HasMaxLength(AssetMaintenanceConsts.MaxAssetNameLength);
            b.Property(x => x.ItemCode).HasMaxLength(AssetMaintenanceConsts.MaxItemCodeLength);
            ...
            b.Property(x => x.AssignTo).HasMaxLength(AssetMaintenanceConsts.MaxAssignToLength);
            b.Property(x => x.AssignToName).HasMaxLength(AssetMaintenanceConsts.MaxAssignToLength);
            b.Property(x => x.CertificateDetails).HasMaxLength(AssetMaintenanceConsts.MaxDescriptionLength);
            b.Property(x => x.Cost).HasPrecision(18, 2);
            b.Property(x => x.Remarks).HasMaxLength(AssetMaintenanceConsts.MaxDescriptionLength);
            b.Property(x => x.Description).HasMaxLength(AssetMaintenanceConsts.MaxDescriptionLength);
            b.Property(x => x.ActionsPerformed).HasMaxLength(AssetMaintenanceConsts.MaxActionsPerformedLength);
            b.Property(x => x.CertificateNo).HasMaxLength(AssetMaintenanceConsts.MaxCertificateNoLength);
            b.HasIndex(x => new { x.TenantId, x.CompanyId, x.AssetId });
            b.HasIndex(x => new { x.TenantId, x.CompanyId, x.Status });
            b.HasIndex(x => new { x.TenantId, x.AssetMaintenanceTaskId });
        });

        builder.Entity<AssetCategory>(b =>
        {
            b.ToTable("Ast_AssetCategories", MyERPConsts.DbSchema);
            b.ConfigureByConvention();
            b.Property(x => x.CategoryName).IsRequired().HasMaxLength(AssetCategoryConsts.MaxCategoryNameLength);
            b.HasMany(x => x.Accounts)
                ...
                .IsRequired()
                .OnDelete(Microsoft.EntityFrameworkCore.DeleteBehavior.Cascade);
            b.HasIndex(x => new { x.TenantId, x.CategoryName });
        });

        builder.Entity<AssetCategoryAccount>(b =>
        {
            b.ToTable("Ast_AssetCategoryAccounts", MyERPConsts.DbSchema);
            b.ConfigureByConvention();
        ...
        builder.Entity<Asset>(b =>
        {
            ...
            b.Property(x => x.Location).HasMaxLength(AssetConsts.MaxLocationLength);
            b.Property(x => x.Notes).HasMaxLength(AssetConsts.MaxNoteLength);
            b.HasMany(x => x.DepreciationSchedule)
                .WithOne()
                .HasForeignKey(x => x.AssetId)
                .IsRequired()
                .OnDelete(Microsoft.EntityFrameworkCore.DeleteBehavior.Cascade);
            b.HasMany(x => x.DepreciationDetails)
                .WithOne()
                .HasForeignKey(x => x.AssetId)
                .IsRequired()
                .OnDelete(Microsoft.EntityFrameworkCore.DeleteBehavior.Cascade);
        ...
        builder.Entity<AssetDepreciationDetail>(b =>
        {
            b.ToTable("Ast_AssetDepreciationDetails", MyERPConsts.DbSchema);
            b.ConfigureByConvention();
            b.HasIndex(x => new { x.AssetId, x.FinanceBookId });
        });

        builder.Entity<AssetActivity>(b =>
        {
            b.ToTable("Ast_AssetActivities", MyERPConsts.DbSchema);
            b.ConfigureByConvention();
            b.Property(x => x.Subject).IsRequired().HasMaxLength(AssetConsts.MaxSubjectLength);
            b.Property(x => x.Details).HasMaxLength(AssetConsts.MaxDescriptionLength);
            b.Property(x => x.ReferenceType).HasMaxLength(AssetConsts.MaxReferenceTypeLength);
            b.Property(x => x.ReferenceId).HasMaxLength(AssetConsts.MaxReferenceIdLength);
            b.HasIndex(x => new { x.TenantId, x.AssetId, x.TransactionDate });
        });
        ...
        builder.Entity<AssetMovement>(b =>
        {
            b.ToTable("Ast_AssetMovements", MyERPConsts.DbSchema);
            b.ConfigureByConvention();
            b.Property(x => x.MovementNumber).IsRequired().HasMaxLength(AssetMovementConsts.MaxMovementNumberLength);
            b.Property(x => x.SourceLocation).HasMaxLength(AssetMovementConsts.MaxLocationLength);
            b.Property(x => x.TargetLocation).HasMaxLength(AssetMovementConsts.MaxLocationLength);
            b.HasMany(x => x.Items)
                .WithOne()
                .HasForeignKey(x => x.AssetMovementId)
                .IsRequired()
                .OnDelete(Microsoft.EntityFrameworkCore.DeleteBehavior.Cascade);
        ...
        {
            b.ToTable("Ast_AssetMovementItems", MyERPConsts.DbSchema);
            b.ConfigureByConvention();
            b.Property(x => x.AssetName).HasMaxLength(AssetConsts.MaxAssetNameLength);
            b.Property(x => x.SourceLocation).HasMaxLength(AssetMovementConsts.MaxLocationLength);
            b.Property(x => x.TargetLocation).HasMaxLength(AssetMovementConsts.MaxLocationLength);
        ...
        {
            b.ToTable("Ast_AssetRepairs", MyERPConsts.DbSchema);
            b.ConfigureByConvention();
            b.Property(x => x.RepairNumber).IsRequired().HasMaxLength(AssetRepairConsts.MaxRepairNumberLength);
            b.Property(x => x.RepairDescription).HasMaxLength(AssetConsts.MaxDescriptionLength);
            b.Property(x => x.ActionsPerformed).HasMaxLength(AssetRepairConsts.MaxActionsPerformedLength);
            b.Property(x => x.Downtime).HasMaxLength(AssetConsts.MaxDowntimeLength);
            b.HasMany(x => x.StockItems)
                .WithOne()
                .HasForeignKey(x => x.AssetRepairId)
                .IsRequired()
                .OnDelete(Microsoft.EntityFrameworkCore.DeleteBehavior.Cascade);
            b.HasMany(x => x.Invoices)
                ...
                .IsRequired()
                .OnDelete(Microsoft.EntityFrameworkCore.DeleteBehavior.Cascade);
            b.HasIndex(x => new { x.TenantId, x.CompanyId, x.RepairNumber });
            b.HasIndex(x => new { x.TenantId, x.CompanyId, x.AssetId });
            b.HasIndex(x => new { x.TenantId, x.CompanyId, x.Status });
        });

        builder.Entity<AssetRepairConsumedItem>(b =>
        {
            b.ToTable("Ast_AssetRepairConsumedItems", MyERPConsts.DbSchema);
            b.ConfigureByConvention();
            b.Property(x => x.ItemName).HasMaxLength(200);
            b.Property(x => x.SerialAndBatchBundleId).HasMaxLength(100);
            b.HasIndex(x => new { x.TenantId, x.AssetRepairId });
            b.HasIndex(x => new { x.TenantId, x.ItemId });
        });

        builder.Entity<AssetRepairPurchaseInvoice>(b =>
        {
            b.ToTable("Ast_AssetRepairPurchaseInvoices", MyERPConsts.DbSchema);
            b.ConfigureByConvention();
            b.Property(x => x.PurchaseInvoiceNumber).HasMaxLength(50);
            b.HasIndex(x => new { x.TenantId, x.AssetRepairId });
            b.HasIndex(x => new { x.TenantId, x.PurchaseInvoiceId });
        });

        builder.Entity<AssetCapitalization>(b =>
        {
            b.ToTable("Ast_AssetCapitalizations", MyERPConsts.DbSchema);
            b.ConfigureByConvention();
            b.Property(x => x.CapitalizationNumber).IsRequired().HasMaxLength(AssetCapitalizationConsts.MaxCapitalizationNumberLength);
            b.Property(x => x.TargetAssetName).HasMaxLength(AssetConsts.MaxAssetNameLength);
            b.HasMany(x => x.StockItems)
                .WithOne()
                .HasForeignKey("AssetCapitalizationId")
                .IsRequired()
                .OnDelete(Microsoft.EntityFrameworkCore.DeleteBehavior.Cascade);
            b.HasMany(x => x.ServiceItems)
                .WithOne()
                .HasForeignKey("AssetCapitalizationId")
                .IsRequired()
                .OnDelete(Microsoft.EntityFrameworkCore.DeleteBehavior.Cascade);
            b.HasMany(x => x.ConsumedAssets)
                .WithOne()
                .HasForeignKey("AssetCapitalizationId")
                .IsRequired()
                .OnDelete(Microsoft.EntityFrameworkCore.DeleteBehavior.Cascade);
            b.HasIndex(x => new { x.TenantId, x.CompanyId, x.CapitalizationNumber });
            b.HasIndex(x => new { x.TenantId, x.CompanyId, x.Status });
        });

        builder.Entity<AssetCapitalizationItem>(b =>
        {
            b.ToTable("Ast_AssetCapitalizationItems", MyERPConsts.DbSchema);
            b.ConfigureByConvention();
            b.Property(x => x.ItemName).IsRequired().HasMaxLength(200);
        });

        builder.Entity<AssetCapitalizationAsset>(b =>
        {
            b.ToTable("Ast_AssetCapitalizationAssets", MyERPConsts.DbSchema);
            b.ConfigureByConvention();
            b.Property(x => x.AssetName).IsRequired().HasMaxLength(AssetConsts.MaxAssetNameLength);
        });

        builder.Entity<AssetValueAdjustment>(b =>
        {
            b.ToTable("Ast_AssetValueAdjustments", MyERPConsts.DbSchema);
            b.ConfigureByConvention();
            b.Property(x => x.AdjustmentNumber).IsRequired().HasMaxLength(AssetValueAdjustmentConsts.MaxAdjustmentNumberLength);
            b.Property(x => x.Notes).HasMaxLength(AssetValueAdjustmentConsts.MaxNotesLength);
            b.HasIndex(x => new { x.TenantId, x.CompanyId, x.AdjustmentNumber });
            b.HasIndex(x => new { x.TenantId, x.CompanyId, x.AssetId });
            b.HasIndex(x => new { x.TenantId, x.CompanyId, x.Status });
        });
    }
